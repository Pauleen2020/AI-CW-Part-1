function init_ga_spider()
    ...
    for frame = 1:GA_PARAMS.GAIT_FRAMES
        % Optional: inspection / could remove for performance
        angles = best_gait(frame, :); %#ok<NASGU>
    end

    % Optional: save video of best gait
    save_spider_gait_video(best_gait, 'best_spider_gait.mp4', 10);

    % Optional: visualize best gait
    % spider_gait(best_gait);

    % Save best gait to .mat file for us
